<template>
  <div>
    ...
    <ol>
      <li
        v-for="mean in meanings"
        :key="mean.meaning"
        class="tw-mt-2"
      >
        <span
          v-html="mean.meaning"
          class="tw-text-2xl tw-p-2 tw-bg-gradient-to-br tw-from-white tw-to-pink-50"
        ></span>

        <h3
          v-if="(mean.examples || mean.egs) && h === 2"
          class="tw-text-base"
        >
          Examples of
        ...
        <h4
          v-if="(mean.examples || mean.egs) && h === 3"
          class="tw-text-base"
        >
          Examples of
          <span class="tw-capitalize">{{ url.title ? url.title : url.slugurl }} ({{ url.transliteration }})</span>
        ...
        <h3
          v-if="(mean.synonyms || mean.syns) && h === 2"
        ...
        <h3
          v-if="(mean.antonyms || mean.ants) && h === 2"
          class="tw-text-base"
        >
          Marwari antonyms of
          <span class="tw-capitalize">{{ url.title ? url.title : url.slugurl }} ({{ url.transliteration }})</span>
        ...
        <h3
          v-if="(mean.related || mean.rels) && h === 2"
          class="tw-text-base"
        >
